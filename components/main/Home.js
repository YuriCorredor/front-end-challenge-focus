    ...
    return (
        <div className="flex p-2 justify-around mt-8">
            <div className="flex flex-col">
                ...
                <a target="_blank" href="https://focusnfe.com.br/doc/#consulta-de-cep-beta_consulta-de-cep-beta" className="mx-4 w-fit p-4 rounded-md text-[#F6F9FF] text-md font-medium bg-primary hover:scale-110 hover:shadow-lg transition-all cursor-pointer">Saiba Mais</a>
            </div>
