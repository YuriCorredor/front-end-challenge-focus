export default function Home() {
    ...
    const text = 'A Focus fornece também "APIs acessórias" para facilitar a vida do desenvolvedor.'
    ...
    return (
        <div className="flex p-2 justify-around mt-8 mb-4">
            <div className="flex flex-col">
                ...
                <p className="text-text_secondary text-md sm:text-lg font-medium p-4 py-0">{text}</p>
